...
async function go(){
  let client = new MongoClient('mongodb+srv://omkar2002:omkar2002@cluster0.afwuxpl.mongodb.net/TodoApp?retryWrites=true&w=majority')
...
function passwordProtected(req, res, next){
  res.set("WWW-Authenticate", "Basic relm='Simple Todo App'")
...
app.post('/create-item', async function(req, res){
  let safeText = sanitizeHtml(req.body.text, {allowdTags: [], allowedAttributes: {}})
